...
1. Download the latest Release.zip file from https://github.com/RaiRaiTheRaichu/SFTOS-TDX-Converter/Releases
2. Extract `TXD Converter.exe` to any folder of your choosing.
3. Run `TXD Converter.exe` and select your .txd files. Multiple files can be selected at once.
